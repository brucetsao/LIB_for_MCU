...
class SdFile {
 ...
 public:
  ...
  SdFile() : type_(FAT_FILE_TYPE_CLOSED), writeError(false){}
  ~SdFile() {close();}
  /**
...
//------------------------------------------------------------------------------------
  ...
  static void printDirName(const dir_t& dir,
    uint8_t width, bool printSlash = true);
...
//------------------------------------------------------------------------------
 private:
  ...
  bool open(SdFile* dirFile, const uint8_t dname[11], uint16_t oflag);
  bool openCachedEntry(uint8_t cacheIndex, uint16_t oflags);
  dir_t* readDirCache();
//------------------------------------------------------------------------------
// Deprecated functions  - suppress cpplint warnings with NOLINT comment
 ...
 /** \deprecated Use:
  ...
  bool open(SdFile& dirFile, // NOLINT
    const char* path, uint16_t oflag) {
   ...
   * \return true for success or false for failure.
   */
  bool open(SdFile& dirFile, uint16_t index, uint16_t oflag) {  // NOLINT
